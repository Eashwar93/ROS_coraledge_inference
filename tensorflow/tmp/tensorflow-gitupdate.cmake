...
execute_process(
  COMMAND "/usr/bin/git" show-ref d855adfc5a0195788bf5f92c3c7352e638aa1109
  WORKING_DIRECTORY "/home/eashwara/edgetpu_video_inference/build/tensorflow/src/tensorflow"
...
if("${show_ref_output}" MATCHES "refs/remotes/d855adfc5a0195788bf5f92c3c7352e638aa1109")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "d855adfc5a0195788bf5f92c3c7352e638aa1109")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "d855adfc5a0195788bf5f92c3c7352e638aa1109")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 d855adfc5a0195788bf5f92c3c7352e638aa1109
  WORKING_DIRECTORY "/home/eashwara/edgetpu_video_inference/build/tensorflow/src/tensorflow"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/tensorflow/tensorflow'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/eashwara/edgetpu_video_inference/build/tensorflow/src/tensorflow/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/eashwara/edgetpu_video_inference/build/tensorflow/src/tensorflow/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
